...
class GalleryPagingAdapter(private val listener: GalleryAdapterClickListener) :
    PagingDataAdapter<MoviesItem, GalleryPagingAdapter.ViewHolder>(DiffCallback()) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (data != null) {
            ...
            holder.itemView.setOnClickListener {
                ...
                intent.putExtra(Constant.MOVIE_ID, data.id)
    ...
    class DiffCallback : DiffUtil.ItemCallback<MoviesItem>() {
...
interface GalleryAdapterClickListener {
    fun displayMovie(movie: MoviesItem)
}